...
const Header = () => {
  ...
  return (
    <section className="lg:bg-blue-1 flex h-screen w-screen flex-row items-center overflow-hidden bg-gradient-to-b from-purple-1 to-purple-2 transition-all md:h-full lg:flex-col lg:px-12 lg:py-16">
