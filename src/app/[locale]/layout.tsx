        ...
        <NextIntlClientProvider messages={messages}>
          <div className="mx-auto my-0 flex min-h-screen w-full flex-col items-center overflow-hidden scroll-smooth bg-black-400">
            <div className="max-w-screen-3xl flex w-screen flex-row items-start justify-center">
              ...
              <div className="h-full min-h-screen w-full flex-col items-center justify-start pt-20 xs:flex lg:w-8/12 lg:border-l lg:border-l-blue-50 lg:border-opacity-20 xl:max-w-screen-lg 2xl:max-w-screen-xl">
                {children}
              </div>
            </div>
          </div>
