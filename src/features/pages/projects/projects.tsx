...
const Projects = () => {
  return (
    <>
      <Navigation />
      <section className="mt-20 flex h-full w-screen flex-col items-center gap-8 overflow-hidden bg-purple-2 py-24 lg:px-12">
          ...
          >
            <div>
              <p>
                ...
                registreren en gedetailleerd kunnen aangeven in welke sectoren
                ze actief zijn en welke vaardigheden
              </p>
              <br />
              <p>
                Dit platform biedt bedrijven de mogelijkheid om hun
                stageplaatsen op een gestructureerde manier te presenteren,
                waardoor potentiële stagiaires gemakkelijk kunnen zien welke
                bedrijven stages aanbieden die aansluiten bij hun studie en
                vaardigheden.
              </p>
